...
### BMI test run
# time Rscript run_rolypoly_multi_expr_datasets.R --gwas_file /projects/timshel/sc-genetics/sc-genetics/data/gwas_sumstats/body_BMI_Locke2015.gwassumstats.rolypoly_fmt.tab.gz --gwas_name TEST_body_BMI_Locke2015 --run_name squared_tss_10kb --n_cores 10 --test_run |& tee log.TEST_body_BMI_Locke2015.out.txt
