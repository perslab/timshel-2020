...
for prefix_genomic_annot, param_dict in dict_cts_conditional.items():
	...
	# for cond_annotation in param_dict["conditional_annotations"]:
		...
		fileout_prefix = "/raid5/projects/timshel/sc-genetics/sc-genetics/out/out.ldsc/{prefix_genomic_annot}__{gwas}__JOINT__{joint_annotation_id_string}".format(gwas=gwas, prefix_genomic_annot=prefix_genomic_annot, joint_annotation_id_string=joint_annotation_id_string)
        ...
        --ref-ld-chr /raid5/projects/timshel/sc-genetics/ldsc/data/baseline_v1.1/baseline.,{ldsc_all_genes_ref_ld_chr_name},{cond_ref_ld_chr_name_joint} \
