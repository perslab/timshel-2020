...
```{r}
df.baseline <- read_tsv("/projects/timshel/sc-genetics/ldsc/src/BMI1.GTEx.cell_type_results.txt")
df.no_baseline <- read_tsv("/projects/timshel/sc-genetics/ldsc/src/BMI1.GTEx_no_baseline.cell_type_results.txt")
```
