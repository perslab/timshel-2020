...
SCRIPT2RUN = "/projects/timshel/sc-genetics/sc-genetics/src/RP-meta/run_rolypoly_multi_expr_datasets-v2.R"
BATCH_SIZE = 3 # maximal number of processes to run cuncurrently



DIR_GWAS = "/projects/timshel/sc-genetics/sc-genetics/data/gwas_sumstats"
OUTDIR = "/projects/timshel/sc-genetics/sc-genetics/src/RP-meta/out.rolypoly_objs-v2"


#DIR_GWAS = "/projects/timshel/sc-genetics/sc-genetics/src/preparation_steps"
...
for i, gwas_file in enumerate(list_files, start=1):
    gwas_name = os.path.basename(gwas_file).split(".")[0] # e.g. mental_NEUROTICISM
        # /projects/timshel/sc-genetics/sc-genetics/data/gwas_sumstats_alkes_UKBB/mental_NEUROTICISM.gwassumstats.rolypoly_fmt.tab.gz --> mental_NEUROTICISM
