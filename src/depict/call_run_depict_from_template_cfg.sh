...
CFG_TEMPLATE=/raid5/projects/timshel/sc-genetics/sc-genetics/src/depict/TEMPLATE_LDSC_MUNGED_GWAS.cfg


###################################### mousebrain_sem_mean ######################################

EXPRESSION_FILE=/raid5/projects/timshel/sc-genetics/sc-genetics/data/genes_cell_type_specific/mousebrain_all.mean.tab
EXPRESSION_NAME=mousebrain_sem_mean

GWAS=BMI_UPDATE_Yengo2018_no_mhc
python ${PY_SCRIPT} --cfg_template_file $CFG_TEMPLATE \
--gwas_summary_statistics_file /raid5/projects/timshel/sc-genetics/sc-genetics/data/gwas_sumstats_ldsc/timshel-collection/$GWAS.sumstats.gz \
...
EXPRESSION_FILE=/raid5/projects/timshel/sc-genetics/sc-genetics/data/genes_cell_type_specific/tabula_muris.mean.tab
...
EXPRESSION_FILE=/raid5/projects/timshel/DEPICT/data-expression/tabula_muris.tissue_celltype.depict.z_score_two_step.tab
...
EXPRESSION_FILE=/raid5/projects/timshel/DEPICT/data-expression/mousebrain.all.depict.z_score_two_step.tab
