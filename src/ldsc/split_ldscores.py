...
def split_M_files(file_ldscore, chromosome, prefix, list_annotations):
	...
	for i in range(len(list_annotations)):
		...
		file_out_M = "{}/{}.{}.{}.l2.M".format(out_dir, prefix, annotation, chromosome)
		file_out_M_5_50 = "{}/{}.{}.{}.l2.M_5_50".format(out_dir, prefix, annotation, chromosome)
...
def all_files_exist(chromosome, prefix, annotations_clean):
	...
	for annotation in annotations_clean:
		...
		file_out_M = "{}.{}.{}.l2.M".format(prefix, annotation, chromosome)
		file_out_M_5_50 = "{}.{}.{}.l2.M_5_50".format(prefix, annotation, chromosome)
		file_out_ldscore = "{}.{}.{}.l2.ldscore.gz".format(prefix, annotation, chromosome)
...
def split_ldscore_file_per_annotation(file_ldscore):
	...
	prefix = m.groups()[0] # e.g nn_lira_sema
	...
	if all_files_exist(chromosome, prefix, annotations_clean):
		print("CHR={} | All files already exists! Will do nothing for this chromosome".format(chromosome))
		return None # do nothing
	else:
		split_M_files(file_ldscore, chromosome, prefix, annotations_clean)
		for counter, annotation in enumerate(annotations_header):
			...
			file_out_ldscore = "{}/{}.{}.{}.l2.ldscore.gz".format(out_dir, prefix, annotation_clean, chromosome)
