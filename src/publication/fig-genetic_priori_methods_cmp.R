...
# p <- ggplot(df.ldsc_cts.spread, aes(x=continuous__es_mean, y=raw__specificity_top10pct_binary)) + 
#   geom_point() +
#   gghighlight((continuous__es_mean > 2), max_highlight = 4L, label_key = annotation) +
#   geom_abline()
# p
