...
# time python -u workflow_ldsc_h2_and_h2_intervals.py |& tee workflow_ldsc_h2_and_h2_intervals.UNNAMED.out.txt
...
### Parallel params
N_PARALLEL_LDSC_REGRESSION_JOBS = 5 # 10-50 jobs works ok because most time is spend on I/O for h2 analysis. Memory footprint is very low.
N_PARALLEL_QUANTILE_PERL_JOBS = 50
N_PARALLEL_H2_RSCRIPT_JOBS = 50


### Quantile params
FLAG_RUN_QUANTILE_H2 = False # Do you want to run quantile h2 analysis?
...
### FULL LIST for h2 [USED FOR OTHER TRAITS]
...
dict_annotations_tm_select_quantile = dict_annotations
...
dict_annotations_wgcna_select_quantile = dict_annotations
...
# dict_run = {"celltypes.mousebrain":
# 						{"dataset":"mousebrain",
# 						"dict_annotations":dict_annotations_mb_select_quantile},
# 			"celltypes.tabula_muris":
# 						{"dataset":"tabula_muris",
# 						"dict_annotations":dict_annotations_tm_select_quantile},
# 			"wgcna.mousebrain-190111":
# 						{"dataset":"mousebrain",
# 						"dict_annotations":dict_annotations_wgcna_select_quantile},
# 			}
