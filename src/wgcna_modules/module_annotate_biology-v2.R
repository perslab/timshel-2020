...
file.ldsc_cts <- here("results/cellect_ldsc/prioritization.csv") # sprintf("/projects/timshel/sc-genetics/sc-genetics/out/out.ldsc/%s__%s.cell_type_results.txt", prefix_genomic_annot, gwas)
...
if (name.dataset == "mousebrain") {
  ...
  stop("Got unsupported name.dataset")
}
