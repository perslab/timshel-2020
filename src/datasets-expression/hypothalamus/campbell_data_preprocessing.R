...
# Load UMI data  
load("/projects/timshel/sc-hypothalamus_atlas_app/data-SCGE/campbell2017/scge.umi.gene_names/GSE93374_Merged_all_020816_DGE.RData") # loads df.dge.campbell2017

# Initialize a Seurat object
seurat_obj <- CreateSeuratObject(raw.data = df.dge.campbell2017, min.cells = 0, min.genes = 0)
...
df.metadata <- read_csv("/projects/timshel/sc-hypothalamus_atlas_app/data-SCGE/metadata/Campbell2017.metavariables-181210.csv") %>% select(-cell_type_glia, 
                                                                                                                                           -cell_type_neurons,
                                                                                                                                           -umi_count_per_cell,
                                                                                                                                           -n_genes_expressed_per_cell,
                                                                                                                                           -cell_barcode)
...
save(seurat_obj, file="/scratch/data-for_fast_access/pub-others/campbell2017/campbell.annotated181210.seurat_obj.RData")
...
file.out.data <- "/scratch/data-for_fast_access/pub-others/campbell2017/campbell.umi.csv"
...
file.out.meta <- "/scratch/data-for_fast_access/pub-others/campbell2017/campbell.cell_metadata.csv"
