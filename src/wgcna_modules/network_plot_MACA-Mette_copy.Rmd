...
```{r}
# Mouse brain
kMEs <- read.csv(gzfile("/projects/timshel/sc-genetics/sc-genetics/out/module_correlation_graph/mousebrain.all_modules_kME.csv.gz"))
...
# Mouse brain
meta <- read.csv("/projects/timshel/sc-genetics/sc-genetics/out/module_correlation_graph/mousebrain.module_prioritization.ldsc.metadata.MULTI_TRAIT.csv")


# Tabula muris
meta <- read.csv("/projects/timshel/sc-genetics/sc-genetics/out/module_correlation_graph/tabula_muris.module_prioritization.ldsc.metadata.MULTI_TRAIT.csv")
